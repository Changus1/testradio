...
], function (declare, Core, dojoLang, dojoQuery, domConstruct, widgetTemplate, _WidgetBase, _TemplatedMixin, dom, dojoDom, dojoProp, dojoGeometry, dojoClass, dojoStyle, dojoConstruct, dojoArray, lang, dojoText, dojoHtml, dojoEvent, widgetTemplate) {
    "use strict";
    ...
    return declare("testradio.widget.testradio", [ Core, _TemplatedMixin ], {
        ...
        postCreate: function () {
			...
			if (attributeType === "Enum") {
				...
				mx.ui.error("GridSearch - Local Checkbox widget only works with Enums.");
			}
        },
